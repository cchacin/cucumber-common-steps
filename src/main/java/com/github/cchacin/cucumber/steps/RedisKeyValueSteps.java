...
public class RedisKeyValueSteps {
    ...
    public void I_have_the_redis_key_with_value(final String key, final Integer db, final String value) throws Throwable {
    ...
    public void I_have_the_redis_key_with_value_in_file(final String key, final Integer db, final String filename) throws Throwable {
        this.I_have_the_redis_key_with_value(key, db, fileContent(filename));
    }

    @Given("^I have the redis key \"([^\"]*)\"(?: in the db (\\d+))? with value:$")
    public void I_have_the_redis_key_with_value_(final String key, final Integer db, final String value) throws Throwable {
        this.I_have_the_redis_key_with_value(key, db, value);
    }

    @Then("^the redis key \"([^\"]*)\"(?: in the db (\\d+))? should be \"([^\"]*)\"$")
    public void the_redis_key_should_be(final String key, final Integer db, final String value) throws Throwable {
        final Jedis jedis = getJedis(db);
    ...
    @Then("^the redis key \"([^\"]*)\"(?: in the db (\\d+))? should be:$")
    public void the_redis_key_should_be_(final String key, final Integer db, final String value) throws Throwable {
        this.the_redis_key_should_be(key, db, value);
    }

    @Then("^the redis key \"([^\"]*)\"(?: in the db (\\d+))? should be file \"([^\"]*)\"$")
    public void the_redis_key_should_be_file(final String key, final Integer db, final String value) throws Throwable {
    ...
    public void I_have_the_redis_key_with_value_with_ttl(final String key, final Integer db, final String value, final int seconds) throws Throwable {
        this.I_have_the_redis_key_with_value(key, db, value);
        final Jedis jedis = getJedis(db);
    ...
    public void the_redis_key_should_not_exists_after_seconds(final String key, final Integer db, final int seconds) throws Throwable {
    ...
    public void the_redis_keys_should_exists(final Integer db, final DataTable dataTable) throws Throwable {
    ...
    public void the_redis_keys_should_not_exists(final String keys, final Integer db) throws Throwable {
        final String[] split = keys.split(",");
        for (final String key : split) {
            this.the_redis_key_should_not_exists(key, db);
        }
