...
public class RedisScoredMembersSteps {
    ...
    public void I_have_the_redis_scored_member_in_the_db_with_score_and_value
    ...
    public void I_have_the_redis_scored_members_in_the_db_with_values(final String key, final int database, final DataTable dataTable) {
    ...
    public void I_should_have_the_redis_scored_members_in_the_db_with_values
