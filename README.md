...
Feature: REST API to manage users
  ...
  Scenario: Retrieve users list
    ...
    """
        [
          {
              "id": "${json-unit.ignore}", // use this for ignore autogenerated fields
              "created": "${json-unit.ignore}", // use this for ignore autogenerated fields
              "modified": "${json-unit.ignore}", // use this for ignore autogenerated fields
